...
LOCAL_CFLAGS := -Wall -O2 -I$(ANDROID_DIR)/$(TARGET_ARCH_ABI)/include -I../../include -DALLEGRO_UNSTABLE

LOCAL_SHARED_LIBRARIES := liballegro_monolith-prebuilt libbass-prebuilt
LOCAL_LDLIBS := -L$(ANDROID_DIR)/$(TARGET_ARCH_ABI)/lib -llog -lz -llua5.2 -lGLESv1_CM -lGLESv2
