...
JNIEXPORT void JNICALL Java_com_nooskewl_m2_MyBroadcastReceiver_pauseSound
...
JNIEXPORT void JNICALL Java_com_nooskewl_m2_MyBroadcastReceiver_resumeSound
  (JNIEnv *env, jobject obj)
{
...
JNIEXPORT jint JNICALL Java_org_liballeg_android_Key_getkey1
  (JNIEnv *env, jobject obj)
{
	return config.getKey1();
}
