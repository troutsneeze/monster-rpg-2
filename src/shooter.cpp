...
#if defined ALLEGRO_IPHONE || defined ALLEGRO_ANDROID || defined ALLEGRO_WINDOWS || defined ALLEGRO_UNIX
	std::list<ZONE>::iterator pause_zone;
#if defined ALLEGRO_WINDOWS || defined ALLEGRO_UNIX
	if (forced_tablet)
#endif
	pause_zone = define_zone(
...
#if defined ALLEGRO_WINDOWS || defined ALLEGRO_UNIX
			if ((forced_tablet && (state.buttons || in.button2)) || (forced_tablet == false && in.button2)) {
